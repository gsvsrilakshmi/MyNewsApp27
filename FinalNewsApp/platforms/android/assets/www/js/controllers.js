...
app.controller('addNewsController',
    function($scope, $location, $cordovaCamera, $http, $cordovaCapture, $cordovaGeolocation) {
                ...
                $cordovaCapture.captureAudio(options).then(function(audioData) {
                  ...
                  var i, pathAudio, len;
                        ...
                        for (i = 0, len = audioData.length; i < len; i += 1) {
                           pathAudio = audioData[i].fullPath;
                  ...
                  // Success! Video data is here
                    var i, pathVideo, len;
                        ...
                        for (i = 0, len = videoData.length; i < len; i += 1) {
                           pathVideo = videoData[i].fullPath;
